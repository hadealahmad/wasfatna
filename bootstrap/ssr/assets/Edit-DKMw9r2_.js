    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "تعديل القائمة" }, null, _parent2, _scopeId));
            ...
            _push2(`<span class="text-foreground font-medium"${_scopeId}>تعديل: ${ssrInterpolate(__props.list.name)}</span></div><h2 class="text-2xl font-bold mb-6"${_scopeId}>تعديل القائمة</h2>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$4), { for: "image" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`تغيير صورة الغلاف`);
                            } else {
                              return [
                                createTextVNode("تغيير صورة الغلاف")
                              ];
                            }
                          }),
                          _: 1
                        ...
                        if (__props.list.cover_image) {
                          _push4(`<div class="mb-2"${_scopeId3}><img${ssrRenderAttr("src", __props.list.cover_image)} class="w-24 h-24 object-cover rounded-md"${_scopeId3}></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(ssrRenderComponent(unref(_sfc_main$5), {
                        ...
                        return [
                          createVNode("form", {
                            ...
                            createVNode("div", { class: "space-y-2" }, [
                              ...
                              __props.list.cover_image ? (openBlock(), createBlock("div", {
                                key: 0,
                                class: "mb-2"
                              }, [
                                createVNode("img", {
            ...
            return [
              createVNode(unref(Head), { title: "تعديل القائمة" }),
              createVNode("div", { class: "flex items-center gap-2 mb-6 text-sm text-muted-foreground" }, [
                ...
                createVNode("span", { class: "text-foreground font-medium" }, "تعديل: " + toDisplayString(__props.list.name), 1)
              ]),
              createVNode("h2", { class: "text-2xl font-bold mb-6" }, "تعديل القائمة"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/My/Lists/Edit.vue");
