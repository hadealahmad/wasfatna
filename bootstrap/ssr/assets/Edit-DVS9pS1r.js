        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), {
              title: `تعديل: ${__props.recipe.name}`
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("my.recipes.index"),
            ...
            _push2(`<span class="text-foreground font-medium"${_scopeId}>تعديل: ${ssrInterpolate(__props.recipe.name)}</span></div><h1 class="text-3xl font-bold mb-8"${_scopeId}>تعديل الوصفة: ${ssrInterpolate(__props.recipe.name)}</h1>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              cities: __props.cities,
              tags: __props.tags,
              users: __props.users,
              "initial-data": __props.recipe
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "container mx-auto py-8 max-w-4xl px-4 md:px-6" }, [
                createVNode("div", { class: "flex items-center gap-2 mb-6 text-sm text-muted-foreground" }, [
                  ...
                  createVNode("span", { class: "text-foreground font-medium" }, "تعديل: " + toDisplayString(__props.recipe.name), 1)
                ]),
                createVNode("h1", { class: "text-3xl font-bold mb-8" }, "تعديل الوصفة: " + toDisplayString(__props.recipe.name), 1),
                createVNode(_sfc_main$2, {
                  cities: __props.cities,
                  tags: __props.tags,
                  users: __props.users,
                  "initial-data": __props.recipe
                }, null, 8, ["cities", "tags", "users", "initial-data"])
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/My/Recipes/Edit.vue");
