...
export default function PendingRecipesPage() {
    ...
    const fetchRecipes = useCallback(async (page = 1, perPage = 20) => {
        ...
        setLoading(true);
        try {
            const response = await api.admin.getPendingRecipes(token, { page, per_page: perPage }) as { recipes: { data: AdminRecipe[] }, pagination: Pagination };
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold tracking-tight">وصفات بانتظار الموافقة</h2>
