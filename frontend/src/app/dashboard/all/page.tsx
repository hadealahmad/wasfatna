...
export default function AllRecipesPage() {
    ...
    const fetchRecipes = useCallback(async (page = 1, perPage = 20) => {
        ...
        setLoading(true);
        try {
            const response = await api.admin.getAllRecipes(token, { page, per_page: perPage }) as { recipes: { data: AdminRecipe[] }, pagination: Pagination };
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold tracking-tight">جميع الوصفات</h2>
